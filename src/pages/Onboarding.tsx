...
import { Zap, Check, Building2, Rocket, Users, Link, ChevronRight } from "lucide-react";
            ...
            <div className="space-y-6 animate-fade-up">
              <div>
                ...
                <p className="text-sm text-muted-foreground mt-1">
                  Comece dando um nome para o seu espaço de trabalho.
                </p>
              </div>
              ...
              <div className="space-y-2">
                ...
                <Input
                  placeholder="Ex: Loja Exemplo BR"
                  value={workspaceName}
          ...
          {step === 2 && (
            <div className="space-y-6 animate-fade-up">
              <div>
                ...
                <p className="text-sm text-muted-foreground mt-1">
                  Conecte as plataformas que você gerencia. Pode pular por agora.
                </p>
              </div>
                  ...
                  return (
                    <div
                      ...
                      className={cn(
                        ...
                        isConnected ? p.color : "border-border bg-muted/20"
                      )}
                    >
              ...
              <div className="flex gap-3">
                <Button variant="ghost" className="flex-1 h-11 text-muted-foreground" onClick={() => setStep(1)}>
                  Voltar
                </Button>
                <Button
                ...
                {connectedPlatforms.length > 0 && (
                  <div className="flex flex-wrap gap-2 justify-center">
                    {connectedPlatforms.map((p) => (
                      <span key={p} className="flex items-center gap-1 text-xs text-success bg-success/10 border border-success/20 px-2.5 py-1 rounded-full">
                        <Check className="w-3 h-3" /> {platforms.find((pl) => pl.id === p)?.name}
                      </span>
                    ))}
                  </div>
                )}
